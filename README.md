...
1️⃣ 后台管理端（手机号 + 密码登录）
角色 手机号 密码 类型 权限说明
馆长（超级管理员） 13900000000 123456 owner 全馆管理：课程/用户/文章/功能开关/操作日志
教练小王 13900000001 123456 teacher 只能管理自己创建的课程和签到核销
教练小李 13900000002 123456 teacher 同上
馆长 = 超级管理员：系统中 isSuperAdmin() 判断逻辑就是
