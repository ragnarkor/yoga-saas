"""约课页头图：从预览图 cover 导出，比例适配 page-header。"""
...
SRC_NAME = "calendar_index_bg_preview.png"
OUT = os.path.join(
    ROOT, "miniprogram", "pages", "default", "skin", "images", "my_course_bg.jpg"
)
TARGET_W = 1500
TARGET_H = 680
# 裁切窗口上移，避免人物头部被切
...
def export_cover(src_path: str, out_path: str) -> None:
    ...
    left = (nw - TARGET_W) // 2
    top = max(0, (nh - TARGET_H) // 2 - int(nh * CROP_TOP_BIAS))
