...
class AdminMeetController extends BaseAdminController {
  ...
  async statusJoin() {
    ...
    let service = new AdminMeetService();
    return await service.statusJoin(
      this._admin,
      input.joinId,
      input.status,
      input.reason,
  ...
  async getMeetList() {
    ...
    let service = new AdminMeetService();
    // [AI_START TIMESTAMP=2025-01-25 11:30:00]
    let result = await service.getMeetList(
      input,
      this._adminId,
      this._adminType,
    );
    // [AI_END LINES=1 TIMESTAMP=2025-01-25 11:30:00]
  ...
  async copyScheduleWeek() {
    ...
    let service = new AdminMeetService();
    let result = await service.copyScheduleWeek(input);
  ...
  async cancelJoinByTimeMark() {
    ...
    let service = new AdminMeetService();
    return await service.cancelJoinByTimeMark(
      this._admin,
      input.meetId,
      input.timeMark,
      input.reason,
